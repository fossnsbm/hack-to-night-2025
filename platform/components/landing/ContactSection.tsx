    ...
    return (
        <Section id="contact">
            <div className="w-full h-full flex flex-col gap-8 items-center justify-center md:p-[25%] text-center">
                ...
                <a className="text-sm md:text-lg p-4 bg-[#0f2537] shadow-[3px_3px_0px_#98c2e1] active:shadow-none active:ml-[2px] active:mt-[2px] rounded transition" href="#">Join WhatsApp</a>
            </div>
        </Section>
    )
}
